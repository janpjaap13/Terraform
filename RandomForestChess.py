...
classifier = RandomForestClassifier(random_state=0, oob_score=True, n_estimators=200, max_depth=16, min_samples_split=2, min_samples_leaf=1, max_features='sqrt')
...
allPredictions = classifier.predict(X_scaled)
